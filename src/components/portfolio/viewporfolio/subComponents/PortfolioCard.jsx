...
import PortfolioCardAvatar from "../../../common/PortfolioCardAvatar";
    ...
    <Paper elevation={0}>
      <Grid container>
        ...
        <Grid item xs={12} md={3}>
          <PortfolioCardAvatar fullName={details?.portfolio_name} photo={details?.photo} designation={details?.designation} />
        </Grid>
