...
import { getAllDeleteData, patchDeleteForeverGoal, patchDeleteForeverKpi, patchDeleteForeverProject, patchDeleteForeverProjectFile, patchDeleteForeverSubtask, patchDeleteForeverSubtaskFile, patchDeleteForeverTask, patchDeleteForeverTaskFile, patchRetrieveGoal, patchRetrieveKpi, patchRetrieveProject, patchRetrieveProjectFile, patchRetrieveSubtask, patchRetrieveSubtaskFile, patchRetrieveTask, patchRetrieveTaskFile } from "../../../../api/modules/TrashModule";
        ...
        Cell: ({ row }) => (
          ...
          >
            <Button
              ...
              size="small"
              variant="contained"
              onClick={() => handleRestore(row.original.all_type, row.original.table_id, row.original.module_id, row.original.file_name)}
            >
              Restore
            </Button>
          </Box>
        ...
        Cell: ({ row }) => (
          ...
          >
            <Button
              ...
              onClick={() => handleDelete(row.original.all_type, row.original.table_id, row.original.module_id, row.original.file_name)}
            >
              Delete
            </Button>
          </Box>
