...
import { getkpiDeleteData, patchDeleteForeverKpi, patchRetrieveKpi } from "../../../../api/modules/TrashModule";
        ...
        Cell: ({ row }) => (
          ...
          >
            <Button
              ...
              size="small"
              variant="contained"
              onClick={() => handleRestore(row.original.kpi_type, row.original.table_id)}
            >
              Restore
            </Button>
          </Box>
        ...
        Cell: ({ row }) => (
          ...
          >
            <Button
              ...
              onClick={() => handleDelete(row.original.kpi_type, row.original.table_id)}
            >
              Delete
            </Button>
          </Box>
