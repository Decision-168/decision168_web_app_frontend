      ...
      <Grid container spacing={1}>
        ...
        <Grid item xs={6}>
          <TextField
            type="date"
            name="startDate"
            value={moment(eventDetails?.startDate).format("YYYY-MM-DD")}
            onChange={handleInputChange}
            fullWidth
            margin="normal"
          />
        ...
        <Grid item xs={6}>
          <TextField
            type="date"
            name="endDate"
            value={moment(eventDetails?.endDate).format("YYYY-MM-DD")}
            onChange={handleInputChange}
            fullWidth
            margin="normal"
          />
        ...
        <Grid item xs={12}>
          <RecurringEvents
            ...
            startDate={moment(eventDetails?.startDate)}
            endDate={moment(eventDetails?.endDate)}
          />
        ...
        <Grid item xs={12}>
          <TextField
            ...
            value={
              eventDetails?.url ||
              "https://dev.decision168.com/meeting/to8-ic1-ouo-01105327"
            }
            onChange={handleInputChange}
            fullWidth
            margin="normal"
