    ...
    <Box sx={{ p: 2, backgroundColor: "whitesmoke", color: theme.palette.primary.contrastText }}>
      <Grid container>
        <Grid item xs={12} md={6}>
          <Typography variant="caption" display="block" gutterBottom textAlign={isSmallScreen ? "center" : "start"}>
        ...
        <Grid item xs={12} md={6}>
          <Typography variant="caption" display="block" gutterBottom textAlign={isSmallScreen ? "center" : "end"}>
