...
import { Popover, Typography, Box, IconButton, useMediaQuery } from "@mui/material";
...
const CommentSection = ({ projectId, taskId, subtaskId, commentModule }) => {
  ...
  }, [commentModule, projectId, subtaskId, taskId, userID]);

  useEffect(() => {
    fetchCommentData();
  }, [subtaskId, taskId, projectId, userID, fetchCommentData]);
