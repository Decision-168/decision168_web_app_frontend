...
const TaskOverviewCardHeader = ({ title, handleClick1, handleClick2, handleClick3, handleDuplicate, handleFileIt, handleDelete, btn1Text, btn2Text, btn3Text, btn1Icon, btn2Icon, btn3Icon }) => {
...
export default memo(TaskOverviewCardHeader);
