...
export default function Copyright() {
  return (
    <Typography component="div" variant="caption" display="block" gutterBottom textAlign="center" p={1}>
      © Copyright 2013 - {new Date().getFullYear()} | <CustomLink path={"https://www.decision168.com/"}>DECISION 168</CustomLink> |{" "}
      ...
      {/* <br /> */}
      All Rights Reserved | Powered by <CustomLink path={"https://www.z2squared.com/"}>z2 Squared </CustomLink>
    </Typography>
  );
}
