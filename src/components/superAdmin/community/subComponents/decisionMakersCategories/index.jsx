      ...
      <Grid container>
        <Grid item xs={12} lg={12} mb={1}>
          <Box
            ...
            <Button sx={{ ml: 2, fontSize: '12px' }} size="small" variant="contained" onClick={() => dispatch(openModal('addCategory'))}>
              <AddIcon sx={{ fontSize: '14px', mr: '2px' }} />
              Add Category
            </Button>
            <ReduxDialog value={'addCategory'} modalTitle={'Add Category'} showModalButton={false} modalSize={'xs'}>
              <AddEditCategoryForm />
            </ReduxDialog>
          </Box>
        </Grid>
