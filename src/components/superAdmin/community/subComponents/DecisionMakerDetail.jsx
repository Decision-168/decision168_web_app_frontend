...
import { getDecisionMakerCategoryDetail } from "../../../../api/super-admin-modules/communityModule";
...
const SocialMediaRow = ({ socialMedia, socialMediaIcon }) => {
  ...
  if (socialMediaIcons.length !== socialMediaLinks.length) {
    console.error(
      "Mismatched array lengths between socialMediaIcons and socialMediaLinks"
    );
    return null;
  }
    ...
    <>
      {detail &&
        detail.map((decisionMakerDetail) => (
          <Box
            key={decisionMakerDetail.reg_id}
            pb={3}
                  ...
                  <Grid item xs={12} display="flex" flexDirection="column">
                    <Grid item xs={12}>
                      ...
                      {decisionMakerDetail.phone_number &&
                        decisionMakerDetail.phone_number != 0 && (
                          <Grid
                            item
                            xs={12}
                            display="flex"
                      ...
                      >
                        ...
                        <Grid item xs={6}>
                          <Typography
                            fontSize="14px"
                            px={1}
                          >{`${decisionMakerDetail.designation} / ${decisionMakerDetail.company}`}</Typography>
                        </Grid>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        <Grid item xs={6}>
                          <Typography fontSize="14px" px={1}>
                            <SocialMediaRow
                              socialMedia={decisionMakerDetail.social_media}
                              socialMediaIcon={
                                decisionMakerDetail.social_media_icon
                              }
                            />
                          </Typography>
                        </Grid>
                      ...
                      >
                        ...
                        <Grid item xs={6}>
                          <Typography fontSize="14px" px={1}>
                            <CategoryChip
                              catIds={decisionMakerDetail.expert_category}
                            />
                          </Typography>
                        </Grid>
                      </Grid>
