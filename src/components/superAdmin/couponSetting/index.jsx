      ...
      <Grid container>
        <Grid item xs={12} lg={12} mb={1}>
          <Box
            ...
            <Button sx={{ ml: 2, fontSize: '12px' }} size="small" variant="contained" onClick={() => dispatch(openModal('addCoupon'))}>
              <AddIcon sx={{ fontSize: '14px', mr: '2px' }} />
              Add New
            </Button>
            <ReduxDialog value={'addCoupon'} modalTitle={"Add Coupon & it's package"} showModalButton={false} modalSize={'sm'}>
