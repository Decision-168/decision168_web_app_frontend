...
import { getProjectInviteRequest } from "../../../api/modules/ProjectModule";

export default function VerifyProjectInviteRequestMember() {
  ...
  useEffect(() => {
    const verifyMember = async () => {
      try {
        const response = await getProjectInviteRequest(
          projectId,
          primaryId,
          flag
        );
    ...
    verifyMember();
  }, [projectId, primaryId, flag, navigate]);
    ...
    >
      ...
      >
        <Box p={2}>
          ...
          >
            {userStatus === "rejected" &&
              "You've rejected the invitation to be a team member for project. If this was by mistake, reach out to the person that invited you."}

            {userStatus === "already_rejected" &&
              "You've already rejected the invitation to be a team member for project. If this was by mistake, reach out to the person that invited you."}
          </Typography>
